...
# Also includes common WhisperX ASR mishears (phonetically similar Arabic words)
SPECIALTY_MAP: dict[str, str] = {
    "طب عام": "طب عام", "طب عائلي": "طب عام",
    "باطنية": "باطنية", "باطنة": "باطنية", "باطني": "باطنية", "داخلية": "باطنية",
    # جلدية — ASR often transcribes as بلدية (ج→ب confusion) or جلديه
    "جلدية": "جلدية", "جلديه": "جلدية", "جلدي": "جلدية", "جلد": "جلدية",
    "بلدية": "جلدية",   # ASR mishear
    "أسنان": "أسنان", "اسنان": "أسنان", "سنان": "أسنان",
    "عظام": "عظام", "عظمي": "عظام",
    "قلب": "قلب", "قلبي": "قلب", "قلبية": "قلب",
    "أطفال": "أطفال", "اطفال": "أطفال",
    "نساء": "نساء", "نسائي": "نساء", "ولادة": "نساء",
    "عيون": "عيون", "عيني": "عيون", "عينية": "عيون",
